  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logoupd.svg" alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://m.facebook.com/profile.php/?id=100004929047782&name=xhp_nt__fb__action__open_user"
            ...
            <li>
              <a
                href="https://www.instagram.com/_ritik_verma/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/ritik-verma-253614249/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Ritik</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
